...
class BasePage(BaseParser):
    ...
    _nav_result: Optional[NavResult] = ...
...
class Messenger(object):
    ...
    def _enable_domain(self, domain: str, **kwargs): ...

    def _disable_domain(self, domain: str, **kwargs): ...
    ...
    def _remove_callback(self, event: str, callback: Callable) -> None:
        """某个动作移除一个触发方法
        :param event: 动作名称
        :param callback: 触发的方法，为None时移除该动作的设置
        :return: None
